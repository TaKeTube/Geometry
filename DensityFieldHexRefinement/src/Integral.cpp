...
double integrateRectangle(double a, double b, function<double(double)> f, int n)
{
...
double integrateTrapeze(double a, double b, function<double(double)> f, int n)
{
	double h, result, t;
...
double integrateSimpson(double a, double b, function<double(double)> f, int n)
{
...
double newtonCotes2(double a, double b, double n, function<double(double)> f)
{
...
double newtonCotes3(double a, double b, double n, function<double(double)> f)
{
	double rez = 0, d = (b - a) / n;
	double xi, xi1;
...
double gauss2(double a, double b, double n, function<double(double)> f)
{
	double rez = 0, d = (b - a)/n;
	double yi, yi1, ai, bi;
...
double gauss3(double a, double b, double n, function<double(double)> f)
{
	double rez = 0, d = (b - a) / n;
